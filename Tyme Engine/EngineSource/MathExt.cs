...
namespace Tyme_Engine.Core
{
    public static class MathExt
    {
        ...
        /// <param name="rotationDeg"> Rotation in Degrees</param>
        /// <returns></returns>
        public static OpenTK.Mathematics.Vector3 GetRightVector(OpenTK.Mathematics.Vector3 rotationDeg) => OpenTK.Mathematics.Vector3.Normalize(OpenTK.Mathematics.Vector3.Cross(GetForwardVector(rotationDeg), OpenTK.Mathematics.Vector3.UnitY));
        ...
        /// <param name="rotationDeg"> Rotation in Degrees</param>
        /// <returns></returns>
        public static OpenTK.Mathematics.Vector3 GetUpVector(OpenTK.Mathematics.Vector3 rotationDeg) => OpenTK.Mathematics.Vector3.Normalize(OpenTK.Mathematics.Vector3.Cross(GetRightVector(rotationDeg), GetForwardVector(rotationDeg)));
    }
}
